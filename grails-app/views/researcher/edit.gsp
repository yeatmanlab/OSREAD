...
<html>
	<head>
		...
		<s2ui:title messageCode='default.edit.label' entityNameMessageCode='researcher.label' entityNameDefault='Researcher'/>
	</head>
	<body>
		<h3><g:message code='default.edit.label' args='[entityName]'/></h3>
		<s2ui:form type='update' beanName='researcher' focus='username' class='button-style'>
