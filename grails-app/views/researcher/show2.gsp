...
<html>
    ...
    <body>
        ...
        <div id="show-researcher" class="content scaffold-show" role="main">
            ...
            <f:display bean="researcher" />
            <g:form resource="${this.researcher}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.researcher}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
